        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <a href="{{ route('client.commandes') }}" class="text-orange-600 hover:text-orange-700 mr-4">
                        <i class="fas fa-arrow-left text-xl"></i>
                    </a>
                    <h1 class="text-2xl font-bold text-orange-600">
                        <i class="fas fa-eye text-3xl mr-2"></i>
                        Détails de la commande #{{ $commande->id }}
                    </h1>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="{{ route('client.panier') }}" class="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg transition duration-300">
                        <i class="fas fa-shopping-cart mr-2"></i>
                        Panier
                    </a>
                    <a href="{{ route('client.profile') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition duration-300">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 flex justify-end space-x-4">
                        <a href="{{ route('client.commandes') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition duration-300">
