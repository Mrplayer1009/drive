...
<div class="space-y-6">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.produits.show', $produit) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition duration-300">
    ...
    <form action="{{ route('admin.produits.update', $produit) }}" method="POST">
        ...
        <div class="flex justify-end space-x-4">
            <a href="{{ route('admin.produits.show', $produit) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded-lg transition duration-300">
                Annuler
            </a>
