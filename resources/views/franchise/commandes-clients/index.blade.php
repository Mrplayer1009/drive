        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('franchise.dashboard') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition duration-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="grid grid-cols-1 md:grid-cols-8 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-gray-600">En attente paiement</p>
                        <p class="text-lg font-bold text-gray-900">{{ $stats['commandes_clients_en_attente'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-lg font-bold text-gray-900">{{ $stats['terminee'] }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white shadow rounded-lg mb-6">
            ...
            <div class="px-6 py-4">
                <div class="flex items-center space-x-4">
                    <!-- Barre de recherche -->
                    <form method="GET" action="{{ route('franchise.commandes-clients.index') }}" class="flex items-center space-x-2">
                        ...
                        @if(request('recherche'))
                            <a href="{{ route('franchise.commandes-clients.index') }}" class="text-gray-500 hover:text-gray-700 text-sm">
                    ...
                    <form method="GET" action="{{ route('franchise.commandes-clients.index') }}" class="flex items-center space-x-2">
                        ...
                        <label for="tri" class="text-sm font-medium text-gray-700">Trier par :</label>
                             ...
                             <option value="date_asc" {{ request('tri') == 'date_asc' ? 'selected' : '' }}>Date (ancien)</option>
                             <option value="prix_desc" {{ request('tri') == 'prix_desc' ? 'selected' : '' }}>Prix (élevé)</option>
                             <option value="prix_asc" {{ request('tri') == 'prix_asc' ? 'selected' : '' }}>Prix (faible)</option>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $commande->client->nom_complet }}</div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('franchise.commandes-clients.show', $commande) }}" class="text-blue-600 hover:text-blue-900 mr-3">
        ...
        @else
            <div class="bg-white shadow rounded-lg p-6 text-center">
                @if(request('recherche'))
                    ...
                    <a href="{{ route('franchise.commandes-clients.index') }}" class="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg transition duration-300">
                ...
                @else
                    ...
                    <p class="text-gray-500">Aucune commande client n'a été reçue pour le moment.</p>
                @endif
            </div>
        @endif
    </div>
